...
import { Box, Heading, Card, Image, Message, AspectImage, AspectRatio, Flex } from 'theme-ui';
...
### Aspect Image
<AspectImage ratio={2 / 1} src={'https://www.stockvault.net/data/2018/08/28/254042/preview16.jpg'} />
<AspectImage ratio={2 / 1} src={Photo} />
...
<!--YouTube embeds-->
<!--<iframe width="100%" height="500" src="https://www.youtube.com/embed/AlfB2oaoVrs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->

<!-- <iframe width="946" height="492" src="https://www.youtube.com/embed/AlfB2oaoVrs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
<Box
  sx={{
    my: 4,
    display: 'grid',
  ...
  <Heading p={3} bg='primary'>
    hello this is gabe.
    i'm writing this here.
    <Text>adding some text</Text>
  </Heading>
  <Heading p={3} bg='primary'>Hello</Heading>
  <Box p={3} color='divide' bg='white'>CSS Grid</Box>
  <Box p={3} color='divide' bg='white'>This is box #2</Box>
...
<Box
  sx={{
    color: 'heading', // theme.colors.primary
    fontSize: 5,      // theme.fontSizes[2]
    my: 5,        // theme.space[3]
    p: 1,
  ...
  <h1>This box has hover effects</h1>
</Box>
